      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <header className="flex items-center justify-between p-6 backdrop-blur-lg bg-white/5 border-b border-white/10">
          ...
          <div className="flex items-center space-x-4">
            <Link href={ROUTES.START_OVER}>
              <Button
                size="sm"
                className="bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 hover:from-cyan-400 hover:via-blue-400 hover:to-purple-500 shadow-lg shadow-blue-500/25 border-0"
              >
                Start Planning
        ...
        <section className="relative text-center py-12 px-6 overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-cyan-500/20 via-blue-500/20 to-purple-500/20 backdrop-blur-lg border border-cyan-400/30 rounded-full mb-6 shadow-2xl shadow-cyan-500/25 hover:shadow-cyan-500/40 transition-all duration-300 group">
              ...
              <span className="text-sm font-semibold bg-gradient-to-r from-cyan-300 via-blue-300 to-purple-300 bg-clip-text text-transparent">
                ✨ AI-Powered Workflow
              </span>
            </div>
            ...
            <div className="relative mb-6">
              <h1 className="text-4xl md:text-7xl font-bold leading-tight tracking-tight">
                ...
                <span className="inline-block text-white mx-2 md:mx-4 opacity-60">
                  →
                </span>
              ...
              <p className="text-lg md:text-xl text-gray-300 mt-4 mb-8 max-w-3xl mx-auto leading-relaxed">
                ...
                with our magical 7-step AI workflow
              </p>
            </div>
            ...
            <div className="mb-10">
                  ...
                  {[
                    {
                      ...
                      href: ROUTES.AI_CONSULTANT,
                      description: "Voice planning",
                    },
                    {
                      step: 2,
                      label: "Idea",
                    ...
                    },
                    {
                      ...
                      href: ROUTES.WIREFRAMES,
                      description: "UI magic",
                    },
                    {
                      step: 7,
                      label: "Stories",
                    ...
                    return (
                      <Link key={item.step} href={item.href}>
                        <div className="group flex flex-col items-center cursor-pointer">
                          <div
                            className={`relative w-12 h-12 md:w-16 md:h-16 bg-gradient-to-r ${item.color} rounded-2xl flex items-center justify-center shadow-lg shadow-black/20 group-hover:shadow-xl group-hover:shadow-current/40 group-hover:scale-110 transition-all duration-300 border border-white/10`}
                          >
                          ...
                          <div className="text-center mt-2 group-hover:scale-105 transition-transform duration-200">
                            <div
                              className={`text-sm font-semibold ${item.textColor} mb-0.5`}
                            >
                              {item.label}
                            </div>
                            <div className="text-xs text-gray-500 whitespace-nowrap leading-tight hidden md:block">
                              {item.description}
                            </div>
                          </div>
                        </div>
              ...
              <div className="mt-6 text-sm text-gray-400 max-w-2xl mx-auto">
                <span className="inline-block bg-gradient-to-r from-cyan-400/20 to-purple-400/20 px-3 py-1 rounded-full border border-white/10">
                  Click any step to jump in, or start from the beginning for the
                  full experience
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
              ...
              <Link href={ROUTES.PLAN}>
                <Button
                  variant="outline"
                  className="group px-8 py-3 border-2 border-purple-400/50 text-purple-300 hover:bg-purple-400/20 hover:border-purple-400/80 backdrop-blur-lg bg-white/5 text-base rounded-xl transition-all duration-300"
                >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
              {[
                ...
                <div
                  key={index}
                  className={`group text-center backdrop-blur-lg bg-gradient-to-br from-white/10 to-white/5 rounded-xl p-4 border ${stat.border} hover:bg-white/10 transition-all duration-300 hover:scale-105`}
                >
                  <div className="text-xs text-gray-400 mb-1 opacity-60">
                    {stat.icon}
                  </div>
                  <div
                    className={`text-xl md:text-2xl font-bold bg-gradient-to-r ${stat.color} bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300`}
                  >
                    {stat.number}
                  </div>
                  <div
                    className={`text-xs font-medium bg-gradient-to-r ${stat.color} bg-clip-text text-transparent opacity-80`}
                  >
                    {stat.label}
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-300 max-w-3xl mx-auto">
                Seven comprehensive steps to transform any idea into
                production-ready code with AI-powered automation at every phase
              </p>
            </div>
                ...
                <div className="relative group cursor-pointer">
                  <div className="backdrop-blur-xl bg-gradient-to-br from-cyan-500/10 via-blue-500/10 to-indigo-500/10 rounded-2xl p-6 border border-cyan-400/30 hover:border-cyan-400/50 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-500/20">
                    ...
                    <p className="text-gray-300 text-sm mb-4 leading-relaxed">
                      Voice-powered conversation to discuss your tech problems
                      and get project plans.
                    </p>
              ...
              <Link href={ROUTES.START_OVER}>
                <div className="relative group cursor-pointer">
                  <div className="backdrop-blur-xl bg-gradient-to-br from-green-500/10 via-emerald-500/10 to-teal-500/10 rounded-2xl p-6 border border-green-400/30 hover:border-green-400/50 transition-all duration-300 hover:shadow-xl hover:shadow-green-500/20">
                    ...
                    <p className="text-gray-300 text-sm mb-4 leading-relaxed">
                      Start with your project concept and let AI transform it
              ...
              <Link href={ROUTES.RESEARCH}>
                <div className="relative group cursor-pointer">
                  <div className="backdrop-blur-xl bg-gradient-to-br from-blue-500/10 via-indigo-500/10 to-purple-500/10 rounded-2xl p-6 border border-blue-400/30 hover:border-blue-400/50 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/20">
                    ...
                    <p className="text-gray-300 text-sm mb-4 leading-relaxed">
                      AI-powered market analysis to discover competitors and
                      opportunities.
                    </p>
                    <div className="space-y-2">
              ...
              <Link href={ROUTES.EDITOR}>
                <div className="relative group cursor-pointer">
                  <div className="backdrop-blur-xl bg-gradient-to-br from-orange-500/10 via-red-500/10 to-pink-500/10 rounded-2xl p-6 border border-orange-400/30 hover:border-orange-400/50 transition-all duration-300 hover:shadow-xl hover:shadow-orange-500/20">
                    ...
                    <p className="text-gray-300 text-sm mb-4 leading-relaxed">
                      Create BPMN 2.0 process flows with stakeholder journeys
                      and decision points.
                    </p>
                    <div className="space-y-2">
              ...
              <Link href={ROUTES.WIREFRAMES}>
                <div className="relative group cursor-pointer">
                  <div className="backdrop-blur-xl bg-gradient-to-br from-teal-500/10 via-cyan-500/10 to-blue-500/10 rounded-2xl p-6 border border-teal-400/30 hover:border-teal-400/50 transition-all duration-300 hover:shadow-xl hover:shadow-teal-500/20">
                    ...
                    <p className="text-gray-300 text-sm mb-4 leading-relaxed">
                      Design responsive UI wireframes with interactive elements
                      and AI-enhanced layouts.
                    </p>
                    <div className="space-y-2">
              ...
              <Link href={ROUTES.STORIES}>
                <div className="relative group cursor-pointer">
                  <div className="backdrop-blur-xl bg-gradient-to-br from-indigo-500/10 via-purple-500/10 to-pink-500/10 rounded-2xl p-6 border border-indigo-400/30 hover:border-indigo-400/50 transition-all duration-300 hover:shadow-xl hover:shadow-indigo-500/20">
                    ...
                    <p className="text-gray-300 text-sm mb-4 leading-relaxed">
                      Generate user stories, acceptance criteria, and Gherkin
              ...
              <Link href={ROUTES.CODE}>
                <div className="relative group cursor-pointer">
                  <div className="backdrop-blur-xl bg-gradient-to-br from-pink-500/10 via-rose-500/10 to-red-500/10 rounded-2xl p-6 border border-pink-400/30 hover:border-pink-400/50 transition-all duration-300 hover:shadow-xl hover:shadow-pink-500/20">
                    ...
                    <p className="text-gray-300 text-sm mb-4 leading-relaxed">
                      Generate production-ready code with complete project
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-300 max-w-2xl mx-auto">
                Advanced capabilities to supercharge your project development
                workflow
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="backdrop-blur-xl bg-white/5 rounded-2xl p-6 border border-cyan-400/30">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  Security-first architecture with compliance frameworks and
              ...
              <div className="backdrop-blur-xl bg-white/5 rounded-2xl p-6 border border-purple-400/30">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  Generate comprehensive project documentation and code in
                  minutes, not weeks.
                </p>
              </div>
              ...
              <div className="backdrop-blur-xl bg-white/5 rounded-2xl p-6 border border-green-400/30">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  Industry best practices and proven methodologies built into
                  every generated output.
                </p>
              </div>

              <Link href={ROUTES.FLOW_MAPPING}>
                <div className="backdrop-blur-xl bg-white/5 rounded-2xl p-6 border border-orange-400/30 hover:border-orange-400/50 transition-all duration-300 cursor-pointer group">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Visualize process flows alongside their corresponding
                    wireframe implementations in one unified view.
                  </p>
                </div>
              </Link>
            </div>
        ...
        <footer className="py-12 px-6 border-t border-white/10">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-gray-400 text-sm max-w-2xl mx-auto mb-6">
              Transform your ideas into production-ready solutions with our
              comprehensive 7-step AI-powered workflow. From concept to code,
