...
export default function MarketResearch() {
  ...
  const performMarketResearch = async () => {
    ...
    try {
      ...
      const researchData = await marketResearchAgent.performMarketResearch(projectInput);
          ...
          <Card className="mb-6 border-0 shadow-sm bg-white">
            ...
            <CardContent className="px-6 pb-6 space-y-4">
              <p className="text-gray-600">
                Enter your project idea and I'll search the web for similar solutions, analyze competitors, and provide market insights to help you understand the competitive landscape.
              </p>
            ...
            <CardContent className="py-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Analyzing competitors, market trends, and opportunities for your project idea...
                </p>
          ...
          <div className="space-y-6">
            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent className="p-6">
                <div className="prose prose-gray max-w-none">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-6">{researchData.marketOverview}</p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="font-semibold text-green-800">Market Size</span>
                      </div>
                      <p className="text-green-700">{researchData.marketInsights.marketSize}</p>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-200 rounded-lg p-4">
                      ...
                      <p className="text-blue-700">{researchData.marketInsights.growthRate}</p>
                    </div>
                    
                    <div className="bg-gradient-to-br from-purple-50 to-indigo-50 border border-purple-200 rounded-lg p-4">
                      <div className="flex items-center gap-2 mb-2">
                        <Target className="h-5 w-5 text-purple-600" />
                        <span className="font-semibold text-purple-800">Competition</span>
                      </div>
                      <p className="text-purple-700">{researchData.marketInsights.competitiveLevel}</p>
                    </div>
                  </div>
                </div>
              </CardContent>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent className="p-6">
                  <div className="space-y-3">
                    {researchData.marketInsights.opportunities.map((opportunity, index) => (
              ...
              <Card className="border-0 shadow-lg">
                ...
                <CardContent className="p-6">
                  <div className="space-y-3">
                    {researchData.marketInsights.keyTrends.map((trend, index) => (
                      <div key={index} className="flex items-start gap-3">
              ...
              <CardContent className="p-6">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="space-y-3">
                      {researchData.recommendations.map((recommendation, index) => (
                        <div key={index} className="flex items-start gap-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-800 mb-3">Differentiation Opportunities</h4>
                    <div className="space-y-2">
                      {researchData.differentiationOpportunities.map((opportunity, index) => (
                        <Badge key={index} variant="outline" className="mr-2 mb-2 bg-indigo-50 border-indigo-200 text-indigo-700">
                          {opportunity}
                        </Badge>
                      ))}
                    </div>
